          ...
          <div className="w-full max-w-4xl">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <h3 className="text-white font-semibold mb-2">الفرع الأول - بنها</h3>
              ...
              <div className="bg-white/5 rounded-lg p-4 border border-white/10">
                <div className="flex items-start gap-3">
                  <MapPin className="h-5 w-5 text-accent mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="text-white font-semibold mb-2">الفرع الثاني - أسنيت كفر شكر</h3>
                    <p className="text-white/80 text-sm leading-relaxed">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-6">
              ...
              >
                ...
                <span className="text-white text-sm font-medium">01222582955</span>
              </a>
              ...
              >
                ...
                <span className="text-white text-sm font-medium">01013210146</span>
              </a>
            </div>
          </div>
