      ...
      <div className="py-8 bg-gradient-to-b from-black/80 to-transparent">
        <div className="container mx-auto px-4">
          <div className="flex flex-wrap justify-center gap-6">
            ...
            />
            <a
              href="https://t.me/samah_furnitures"
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center justify-center gap-2 bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 rounded-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105"
            >
              <svg
                viewBox="0 0 24 24"
                width="24"
              ...
              <span className="font-semibold">تواصل معنا على تيليجرام</span>
            </a>
          </div>
        </div>
      </div>
